    ...
    extends Domain
{
     ...
     * @return mixed|null
     */
    final public function forgotMyPasswordUseEmail($email )
    {
        $retVal = null;
     ...
     * @return mixed|null
     */
    final public function forgotMyPasswordUseUsername($username )
    {
        return null;
    }
                                    ...
                                    $address )
    {
        ...
        $profile = $this->registerProfile( $profile );

        $pi = $this->registerProfileInformation(  $profile,
            $name,
            $email,
            $birthday,
            $phone_number,
     ...
     * @throws Exception
     */
    final public function registerProfileInformation($profile,
                                                     $name,
                                                     $email,
                                                     $birthday,
                                                     $phone_number,
     ...
     * @throws Exception
     */
    final public function registerProfile($profile_variable )
    {
        //
        $connection = new MySQLConnectorWrapper( $this->getInformation() );
                                 ...
                                 $password )
    {
        ...
        if( password_verify( $password, $arr->getPassword() ) )
        {
            return $arr;
        }
